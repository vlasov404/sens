...
return [
    ...
    'HOOKAH_HALL' => "Зал",
    'HOOKAH_HALL_BIG' => "Большой",
    'HOOKAH_HALL_SMALL' => "Малый",
    'HOOKAH_NUMBER_TABLE' => "Номер стола",
    'HOOKAH_STURDINESS' => "Крепкость",
    'HOOKAH_PARAMS' => "Дополнительно",
    'HOOKAH_PARAMS_FRESH' => "Свежий",
    'HOOKAH_PARAMS_SWEET' => "Сладкий",
    'HOOKAH_PARAMS_SOUR' => "Кислый",
    'HOOKAH_PARAMS_TART' => "Терпкий",
    'HOOKAH_MESSAGE' => "Комментарий",
    'HOOKAH_SUBMIT_RESULT' => "Спасибо! Ваш заказ принят!",
];